...
public class UserLogCRUDTest {
	...
	void createDietRecordTest() {
		...
		Ingredient ingredient = new Ingredient("chicken rice");
		iRepo.saveAndFlush(ingredient);
		DietRecord fd1 = new DietRecord(usGot, ingredient, MealType.DINNER, 400.0, 250.0);
	...
	void updateDietRecordTest() {
		...
		Ingredient ingredient = new Ingredient("chicken rice");
		iRepo.saveAndFlush(ingredient);
		DietRecord fd1 = new DietRecord(user1, ingredient, MealType.DINNER, 400.0, 250.0);
		fdRepo.saveAndFlush(fd1);
