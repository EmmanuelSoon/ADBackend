...
public class DataSeedingService {
    ...
    private NutritionRecord createNutritionRecordByList(List<WeightedIngredient> ingredientList) {
        ...
        for (WeightedIngredient weightedIngredient : ingredientList) {
            ...
            if (currRecord.getTotalCalories() > 0){
                nutritionRecord.setTotalCalories(nutritionRecord.getTotalCalories() + currRecord.getTotalCalories() * weight/100.0);
            }
            ...
            if (currRecord.getVitaminB12() > 0) {
                nutritionRecord.setVitaminB12(nutritionRecord.getVitaminB12() + currRecord.getVitaminB12() * weight/100.0);
            }
            if (currRecord.getVitaminB6() > 0) {
                nutritionRecord.setVitaminB6(nutritionRecord.getVitaminB6() + currRecord.getVitaminB6() * weight/100.0);
            }
            ...
            if (currRecord.getCholesterol() > 0) {
                nutritionRecord.setCholesterol(nutritionRecord.getCholesterol() + currRecord.getCholesterol() * weight/100.0);
            }
    ...
    public void seedDishAndRecipe() {
        ...
        String[] Ingredients2 = new String[]{"Raw Chicken Breast", "Noodles", "Egg", "Xiao Bai Cai", "Salt", "Water"};
